...
-- Erstellungszeit: 03. Jan 2026 um 21:26
...
--
-- Tabellenstruktur für Tabelle `ad_charts`
--
...
--
-- Tabellenstruktur für Tabelle `ad_charts2`
--
...
CREATE TABLE IF NOT EXISTS `aircraft_perf_dist` (
...
CREATE TABLE IF NOT EXISTS `aircraft_weight_items` (
                                                       `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `aircraft_id` int(11) UNSIGNED NOT NULL,
    `type` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `aircraft_wnb_envelopes` (
                                                        `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `aircraft_id` int(11) UNSIGNED NOT NULL,
    `name` varchar(100) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `basestation_aircrafts`
--
...
--
-- Tabellenstruktur für Tabelle `faa_notam`
--
...
--
-- Tabellenstruktur für Tabelle `faa_notam_geometry`
--

CREATE TABLE IF NOT EXISTS `faa_notam_geometry` (
                                                    `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Tabellenstruktur für Tabelle `geonames`
--
...
--
-- Tabellenstruktur für Tabelle `geonames_admin1codes`
--
...
--
-- Tabellenstruktur für Tabelle `geonames_admin2codes`
--
...
--
-- Tabellenstruktur für Tabelle `geonames_bak`
--
...
--
-- Tabellenstruktur für Tabelle `geonames_eu`
--
...
--
-- Tabellenstruktur für Tabelle `global_waypoints`
--
...
--
-- Tabellenstruktur für Tabelle `icao_aircraft_type`
--
...
--
-- Tabellenstruktur für Tabelle `icao_aircraft_type_BAK`
--

CREATE TABLE IF NOT EXISTS `icao_aircraft_type_BAK` (
                                                        `id` int(11) NOT NULL AUTO_INCREMENT,
    `designator` varchar(4) NOT NULL,
    `model` varchar(100) NOT NULL,
    `manufacturer` varchar(100) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `icao_fir`
--
...
--
-- Tabellenstruktur für Tabelle `icao_notam`
--
...
--
-- Tabellenstruktur für Tabelle `icao_notam_geometry`
--
...
--
-- Tabellenstruktur für Tabelle `icao_notam_geometry2`
--
...
--
-- Tabellenstruktur für Tabelle `icao_telephony_designator`
--
...
--
-- Tabellenstruktur für Tabelle `ivao_circuits`
--
...
--
-- Tabellenstruktur für Tabelle `lfr_ch`
--
...
--
-- Tabellenstruktur für Tabelle `map_features`
--
...
--
-- Tabellenstruktur für Tabelle `meteo_sma_measurements`
--
...
--
-- Tabellenstruktur für Tabelle `meteo_sma_stations`
--
...
--
-- Tabellenstruktur für Tabelle `meteo_sma_stations_bak`
--
...
--
-- Tabellenstruktur für Tabelle `navplan`
--
...
--
-- Tabellenstruktur für Tabelle `navplan_waypoints`
--
...
--
-- Tabellenstruktur für Tabelle `ogn_filter`
--
...
--
-- Tabellenstruktur für Tabelle `ogn_listener`
--
...
--
-- Tabellenstruktur für Tabelle `ogn_traffic`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_airports`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_airports2`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_airports2_BAK`
--

CREATE TABLE IF NOT EXISTS `openaip_airports2_BAK` (
                                                       `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `type` varchar(20) NOT NULL,
    `country` varchar(2) NOT NULL,
    `name` varchar(50) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `openaip_airspace`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_airspace2`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_airspace2_BAK`
--

CREATE TABLE IF NOT EXISTS `openaip_airspace2_BAK` (
                                                       `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `category` varchar(20) NOT NULL,
    `class` varchar(30) DEFAULT NULL,
    `type` varchar(30) DEFAULT NULL,
...
--
-- Tabellenstruktur für Tabelle `openaip_airspace_detaillevels`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_navaids`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_navaids2`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_navaids2_BAK`
--

CREATE TABLE IF NOT EXISTS `openaip_navaids2_BAK` (
                                                      `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `type` varchar(20) NOT NULL,
    `country` varchar(2) NOT NULL,
    `name` varchar(20) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `openaip_radios`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_radios2`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_radios2_BAK`
--

CREATE TABLE IF NOT EXISTS `openaip_radios2_BAK` (
                                                     `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `airport_id` int(10) UNSIGNED NOT NULL,
    `category` varchar(20) NOT NULL,
    `frequency` float NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `openaip_runways`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_runways2`
--
...
--
-- Tabellenstruktur für Tabelle `openaip_runways2_BAK`
--

CREATE TABLE IF NOT EXISTS `openaip_runways2_BAK` (
                                                      `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
    `airport_id` int(10) UNSIGNED NOT NULL,
    `operations` varchar(20) NOT NULL,
    `name` varchar(20) NOT NULL,
...
--
-- Tabellenstruktur für Tabelle `reporting_points`
--
...
--
-- Tabellenstruktur für Tabelle `user_tracks`
--
...
--
-- Tabellenstruktur für Tabelle `user_waypoints`
--
...
--
-- Tabellenstruktur für Tabelle `webcams`
--
...
--
-- Constraints der Tabelle `user_waypoints`
--
